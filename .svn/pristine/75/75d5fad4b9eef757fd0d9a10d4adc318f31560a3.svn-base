		...
		<view id="content-view" :style="'min-height:'+scrollHeight+'px;'">
			...
			<template v-if="level<=1 && platForm ==2">
				<view  class="user-upgrade-vip-view">
					<!-- #ifdef MP-WEIXIN -->
					<button  open-type="contact"  class="contact-btn" id="contact-btn-view">
						<img src="https://imgmyqx.ofbei.com/images/contact_consumer_ios.png" class="user_upgrade_vip" />
					</button>
					<!-- #endif -->
					
					<!-- #ifdef MP-QQ -->
					<button  @tap="copy_customer_qq"  class="contact-btn" id="contact-btn-view">
						<img src="https://imgmyqx.ofbei.com/images/contact_consumer_ios.png" class="user_upgrade_vip" />
					</button>
					<!-- #endif -->
					...
					<!-- #ifdef APP-PLUS || H5 -->
					<!--
					<button  class="contact-btn" id="contact-btn-view" @tap="upgrade_vip">
