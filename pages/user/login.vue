		...
		<view id="login-area-view" :style="'top:'+loginViewTop+'px'">
			...
			<view id="user-allow-info" :style="'margin-bottom:'+allInfoBottom+'px;'">
				<checkbox-group @change="checkboxChange" style="display:flex;flex-direction: row;align-items: center;">
					...
					<view>
						<view>登录即代表同意
							<navigator url="/pages/user/user_agreement" tap="gotoUserAllowPage" class="underline-text">用户协议</navigator> 和
							<navigator tap="gotoUserLicensePage" class="underline-text" url="/pages/user/software_license">隐私政策</navigator>
						</view>
					</view>
			...
			<view id="login-view">
				...
				-->
				<view id="login-view-box" :style="(( system < 13 && platform == 2 ) || platform!=2) ? 'justify-content:center':''">
					<view @tap="thirdLoginByWx">
						<image src="../../static/img/user/weichat.png" class="login-icon" style="height:44px;width:44px;"></image>
					</view>
